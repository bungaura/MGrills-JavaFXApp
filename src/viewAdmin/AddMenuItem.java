...
//AddMenuItem class representing the view for adding a menu item in the admin dashboard
public class AddMenuItem extends Stage {
	...
	//Initializes the add menu item view, including the menu item table and form
	...
	//Creates the grid pane containing the add menu item form
