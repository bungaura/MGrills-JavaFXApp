...
//UserManagement class representing the user management view in the admin dashboard
public class UserManagement extends Stage {
  ...
  //Returns the root node of the view
	...
	//Initializes the user management view, including the user table and form
	...
	//Creates and configures the user table
  ...
  //Creates the grid pane containing the user management form
