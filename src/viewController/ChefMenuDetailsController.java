...
//ChefMenuDetailsController manages the addition of menu items to the customer's order
public class ChefMenuDetailsController {
	private int orderId;
		
	// Constructor initializing the controller with the current user
	public ChefMenuDetailsController(int orderId) {
