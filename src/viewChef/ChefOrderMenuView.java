...
import viewController.ChefMenuViewController;


//ChefOrderMenuView class representing the view for viewing menu items in the chef dashboard
public class ChefOrderMenuView extends Stage{
	
	private TableView<MenuItem> table;
	private VBox root = new VBox();
	private ChefMenuViewController controller;
	...
	// Initialize the Chef Order View
    public void initialize(int orderId) {
        ...
        controller = new ChefMenuViewController(orderId, table);
