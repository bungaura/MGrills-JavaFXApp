...
public class MenuItem {
	...
	// Creates a new menu item with the given details
	...
	// Updates an existing menu item with the specified Menu Item ID
	...
	// Retrieves the MenuItem object by ID
	...
	// Checks if a menu item with the given name is already registered in the database
