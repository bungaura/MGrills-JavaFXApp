...
// Register class representing the registration view
public class Register extends Stage {
    ...
    // Constructor for RegisterController, connecting UI components with logic
    // The RegisterController handles user registration logic and input validation
    ...
    public GridPane initialize() {
        ...
        // Handles the register button click event, triggering registration process
