...
import viewController.WaiterOrderUpdateController;

// WaiterOrderUpdate class representing the view for updating menu quantity of selected order in the waiter dashboard
public class WaiterOrderUpdate extends Stage { 
	private TextField qtyInput = new TextField();
	private Label nameLbl, messageLbl;
	private VBox root;
	private Button cancelBtn, saveBtn, removeBtn;
	private WaiterOrderUpdateController controller;
	...
	public void initialize(int orderId, int orderItemId, int menuItemId, String menuItemName, int qty) {
		...
		controller = new WaiterOrderUpdateController();
