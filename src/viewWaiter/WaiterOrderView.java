...
// WaiterOrderView class representing the view for viewing order items in the waiter dashboard
public class WaiterOrderView {
    ...
    // Initializes the Waiter Order View
    ...
    // Creates and configures the TableView for displaying orders
