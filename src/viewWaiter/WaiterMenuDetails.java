...
import viewController.WaiterMenuDetailsController;

// WaiterMenuDetails class representing the view for viewing menu details of each menu in the waiter dashboard
public class WaiterMenuDetails extends Stage { 
	...
	private WaiterMenuDetailsController controller;
	private int orderId;
	
    // Constructor to set the order ID
	public WaiterMenuDetails(int orderId) {
		this.orderId = orderId;
	}

    // Initialize the Waiter Menu Details view with menu item details
	...
	private void showMenuDetails(int menuItemId, String name, String desc, Double price) {
        ...
        addToOrderBtn.setOnAction(e -> {
            ...
            if (validationMessage == null) {
                ...
                controller = new WaiterMenuDetailsController(orderId);
        ...
        seeOrderBtn.setOnAction(e -> {
        	close();
        	new WaiterOrderDetails().initialize(orderId);
        });
