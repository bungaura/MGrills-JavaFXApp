...
//CashierOrderView class representing the view for cashier order management
public class CashierOrderView {
    ...
    //Initializes the CashierOrderView, including the order table
    ...
    //Creates and configures the order table
