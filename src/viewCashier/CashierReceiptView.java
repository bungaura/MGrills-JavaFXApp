...
// CashierReceiptView class representing the view for cashier receipt management
public class CashierReceiptView extends Stage {
	...
	// Initializes the CashierReceiptView, including the receipt details form and table
    ...
    // Creates and configures the receipt details form.
    private TableView<Receipt> createOrderTable() {
  	...
  	// Button action to view details of a selected receipt.
    private GridPane viewReceiptForm(TableView<Receipt> table) {
        ...
        errorLbl.setTextFill(Color.RED);
      	...
      	//Button to view details of a selected receipt
